...
HUB_NPCS = [
    ...
    Npc('elizabeth',
        ...
        trades=[
            ...
            (14_999, {'name': 'enchanted_book',
                      'enchantments': {'looting': 4}}),
            (19_999, {'name': 'enchanted_book',
                      'enchantments': {'scavenger': 4}}),
            (19_999, {'name': 'hot_potato_book'}),
            (49_999, {'name': 'enchanted_book',
                      'enchantments': {'luck': 6}}),
            (199_999, {'name': 'enchanted_book',
                       'enchantments': {'last_stand': 1}}),
            (1_099_999, {'name': 'fuming_potato_book'}),
            ...
            (14_999_999, {'name': 'enchanted_book',
                          'enchantments': {'scavenger': 5}}),
            (49_999_999, {'name': 'enchanted_book',
                          'enchantments': {'luck': 7}}),
            (149_999_999, {'name': 'enchanted_book',
                           'enchantments': {'chimera': 1}}),
            (249_999_999, {'name': 'enchanted_book',
